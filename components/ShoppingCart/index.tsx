...
function ShoppingCart() {
	...
	const formattedTotalPrice = typeof(totalPrice) == 'number' ? (totalPrice / 100).toFixed(2) : totalPrice
						...
						>
							<aside className='bg-white h-full flex flex-col lg:rounded-2xl'>
								...
								<div className='flex justify-between px-4 py-3 lg:p-6 shrink-0'>
									...
									{/*Close Icon*/}
									<button onClick={toggleOpen} className='hover:bg-gray-100 active:bg-gray-200 transition active:shadow-inner active:bg-gray-200 bg-white w-[3rem] h-[3rem] text-[1.5rem] flex justify-center items-center rounded-full'>
										<MdClose/>
									</button>
								</div>
