            ...
            >
                ...
                <div className="flex flex-col gap-2 lg:gap-4 justify-center">
                    ...
                    >
                        ...
                        {discountPercentage && (
                            <span className="order-first lg:order-last text-white text-sm line-through flex justify-center items-center bg-alert rounded-2xl px-2 py-1">
                                {initialFormattedPrice} zł
                            </span>
                        )}
                    </div>
                    {/*Add to cart button*/}
                    <AddToCartButton
                        id={id}
                        className="lg:order-last flex gap-2 justify-center items-center lg:w-fit"
                    />
                    {/*Description*/}
                    <div
                        className="
